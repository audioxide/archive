...
<header class="navbar">
    <a href="/" class="audioxide-archive-logo"><span class="logo">Audioxide</span> Archive</a>
    <a href="https://audioxide.eo.page/newsletter"><span class="subscription-prompt">Subscribe for monthly roundups</span> →</a>
    <nav class="dropdown">
        <button class="dropbtn">Browse editions
